...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        configureHeroHeadView()
    }
    
    private func configureHeroHeadView(){
        APICaller.shared.getTrendingMovies { [weak self]result in
            ...
            case .success(let titles) :
                ...
                self?.headerView?.configure(with: UpcomingTitleViewModel(titleName: selectedTitle?.original_title ?? selectedTitle?.original_name ?? "", posterURL: selectedTitle?.poster_path ?? "", releaseDate: ""))
